                    ...
                    <table className="min-w-full text-xs">
                      <thead className="bg-slate-50 sticky top-0">
                        <tr>
                          ...
                          <th className="px-3 py-2 text-left font-black text-slate-500">SAP</th>
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {importRows.map((row, i) => (
                          <tr key={i} className="hover:bg-slate-50">
                            ...
                            <td className="px-3 py-2 font-black text-blue-700">{row['Código Ruta*'] || row['Código Ruta'] || <span className="text-red-500">⚠ falta</span>}</td>
                            <td className="px-3 py-2 font-semibold text-slate-800">{row['Nombre Ruta*'] || row['Nombre Ruta']}</td>
                            <td className="px-3 py-2 text-slate-600">{row['SAP']}</td>
