...
// ─── Helpers de validación de input ───────────────────────────────────────────
  ...
  const handleConfirmarImport = async () => {
    ...
    for (let i = 0; i < importRows.length; i++) {
      ...
      const payload: any = {
        ...
        telefono: String(row['Teléfono'] || '').replace(/\D/g, '') || null,
            ...
            <form onSubmit={handleSave} className="p-4 sm:p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <input required type="text" value={editGanadero.codigo_ganadero}
                ...
                <div className="sm:col-span-2">
                  ...
                  <input required type="text" value={editGanadero.nombre} onChange={e => setEditGanadero({ ...editGanadero, nombre: e.target.value })}
                    placeholder="Nombre completo"
                    className="w-full border border-slate-300 rounded-lg p-2.5 text-sm font-bold focus:ring-2 focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase mb-1">Cédula (solo números)</label>
                  <input type="text" value={editGanadero.cedula || ''} onKeyDown={soloNumeros}
                    onChange={e => setEditGanadero({ ...editGanadero, cedula: e.target.value.replace(/\D/g, '') })}
                ...
                <div>
                  ...
                  <input type="text" value={editGanadero.rif || ''} onKeyDown={soloNumeros}
                    onChange={e => setEditGanadero({ ...editGanadero, rif: e.target.value.replace(/\D/g, '') })}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase mb-1">Teléfono (solo números)</label>
                  <input type="text" value={editGanadero.telefono || ''} onKeyDown={soloNumeros}
                    onChange={e => setEditGanadero({ ...editGanadero, telefono: e.target.value.replace(/\D/g, '') })}
                    placeholder="Ej: 04141234567" inputMode="tel"
                    className="w-full border border-slate-300 rounded-lg p-2.5 text-sm font-bold focus:ring-2 focus:ring-blue-500" />
                </div>
                <div>
